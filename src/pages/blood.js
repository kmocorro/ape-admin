...
export default function Index() {
  ...
  async function handleSubmitRegister(){
    ...
    let response = await fetch('http://localhost:8080/api/employee', {
      headers: headers,
      method: 'POST',
      body: JSON.stringify({
            ...
            {!toggle_employee_number ? (
              ...
              */}
              <Container>
                <Grid>
                  <Grid item>
                    <Typography>This is where to complete the station. Admin will select the process and click submit.</Typography>
                  </Grid>
                </Grid>
              </Container>
